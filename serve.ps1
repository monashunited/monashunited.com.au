...
if ($DOCKER_INSPECT_CHECK -contains "running") {
  ...
  docker run --name $CONATINER_NAME -it --rm -p 8105:8100 -p 35728:35729 -v ${PWD}:/build/source:rw aemdesign/centos-java-buildpack bash --login /build/source/docker-serve.sh
}
